 ...
 * message consist of a main part plus several optional parts called "extras". These extras can be text, or other
 * ChatMessage.
 * 
...
public abstract class ChatMessage {
	 ...
	 * 
	 * @return true if it's strikethrough, false if it's not strikethrough or if the strikethrough property is unset.
	 */
