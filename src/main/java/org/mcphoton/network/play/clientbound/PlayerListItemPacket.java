			...
			switch (action) {
				case 0:
					...
					for (int iproperty = 0; iproperty < playersProperties.length; iproperty++) {
						...
						if (ProtocolHelper.readBoolean(buff)) {
							signature = ProtocolHelper.readString(buff);
						}
					...
					if (ProtocolHelper.readBoolean(buff)) {
						displayName0 = ProtocolHelper.readString(buff);
					}
				...
				case 3:
					...
					if (ProtocolHelper.readBoolean(buff)) {
						displayName3 = ProtocolHelper.readString(buff);
					}
